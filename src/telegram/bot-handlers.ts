...
function hasReplyTargetMedia(msg: Message): boolean {
  const replyTarget = resolveTelegramReplyTargetMessage(msg);
...
export const registerTelegramHandlers = ({
  ...
  const resolveTelegramSessionState = (params: {
    ...
    const peerId = resolveTelegramRoutingPeerId({
  ...
  const resolveReplyMediaForMessage = async (
    ...
    const replyMessage = resolveTelegramReplyTargetMessage(msg);
