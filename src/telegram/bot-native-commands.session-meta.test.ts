...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  it("routes direct-message native commands by sender id when chat id differs", async () => {
    const cfg: OpenClawConfig = {
    ...
    expect(dispatchCall?.ctx?.CommandTargetSessionKey).toContain("telegram:direct:200");
  });
