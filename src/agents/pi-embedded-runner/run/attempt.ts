...
export async function runEmbeddedAttempt(
  ...
  try {
    const { shouldLoadSkillEntries, skillEntries, runtimePathPrepend } =
    ...
    const toolsRaw = params.disableTools
      ...
      : createOpenClawCodingTools({
          ...
          extraExecPathPrepend: runtimePathPrepend,
          exec: {
    ...
    try {
      ...
      const {
        ...
        getSuccessfulMutatingToolCalls,
      ...
      return {
        ...
        successfulMutatingToolCalls: getSuccessfulMutatingToolCalls(),
