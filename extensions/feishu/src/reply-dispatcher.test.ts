...
describe("createFeishuReplyDispatcher streaming behavior", () => {
  ...
  it("buffers non-card block payloads until idle when streaming is unavailable", async () => {
    createFeishuReplyDispatcher({
      cfg: {} as never,
      agentId: "agent",
      runtime: {} as never,
  ...
  it("flushes block-only replies in thread mode without starting streaming", async () => {
    resolveFeishuAccountMock.mockReturnValue({
      accountId: "main",
      appId: "app_id",
      appSecret: "app_secret",
  ...
  it("flushes block-only replies in raw mode as plain text", async () => {
    resolveFeishuAccountMock.mockReturnValue({
      accountId: "main",
      appId: "app_id",
      appSecret: "app_secret",
